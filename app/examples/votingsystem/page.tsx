...
<span style="font-weight: bold">where</span>
    ...
    fun replaceCandidate <span style="font-weight: bold">::</span> <span style="font-weight: bold">Candidate</span>, <span style="font-weight: bold">Candidate</span>, <span style="font-weight: bold">MemData</span> <span style="font-weight: bold">-&gt;</span> <span style="font-weight: bold">MemData</span> <span style="font-weight: bold">=</span>
        prevCandidate, newCandidate, memData <span style="font-weight: bold">-&gt;</span> 
            (<span style="font-weight: bold">Voters</span> <span style="font-weight: bold">:=</span> <span style="font-weight: bold">-&gt;</span> <span style="font-weight: bold">Voters</span>(memData),
             <span style="font-weight: bold">Candidates</span> <span style="font-weight: bold">:=</span> <span style="font-weight: bold">-&gt;</span> newCandidate<span style="font-weight: bold">:</span>removeCandidate(<span style="font-weight: bold">CName</span>(prevCandidate), <span style="font-weight: bold">Candidates</span>(memData)))
 

defn
    proc memAccessRacer <span style="font-weight: bold">::</span> 
        | <span style="font-weight: bold">Put</span>( () |<span style="font-weight: bold">Passer</span>(|<span style="font-weight: bold">MemCell</span>(<span style="font-weight: bold">A</span> | ))), <span style="font-weight: bold">Put</span>( () |<span style="font-weight: bold">Passer</span>(|<span style="font-weight: bold">MemCell</span>(<span style="font-weight: bold">A</span> | ))), <span style="font-weight: bold">Put</span>( () |<span style="font-weight: bold">Passer</span>(|<span style="font-weight: bold">MemCell</span>(<span style="font-weight: bold">A</span> | ))) <span style="font-weight: bold">=&gt;</span> <span style="font-weight: bold">MemCell</span>(<span style="font-weight: bold">A</span> | ) <span style="font-weight: bold">=</span> 
    ...
    proc memAccessHelper <span style="font-weight: bold">::
        </span>| <span style="font-weight: bold">Put</span>( () |<span style="font-weight: bold">Passer</span>(|<span style="font-weight: bold">MemCell</span>(<span style="font-weight: bold">A</span> | ))), <span style="font-weight: bold">Put</span>( () |<span style="font-weight: bold">Passer</span>(|<span style="font-weight: bold">MemCell</span>(<span style="font-weight: bold">A</span> | ))), <span style="font-weight: bold">Put</span>( () |<span style="font-weight: bold">Passer</span>(|<span style="font-weight: bold">MemCell</span>(<span style="font-weight: bold">A</span> | ))) <span style="font-weight: bold">=&gt;</span> <span style="font-weight: bold">MemCell</span>(<span style="font-weight: bold">A</span> | ) <span style="font-weight: bold">=</span>
